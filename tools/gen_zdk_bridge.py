...
def emit(exports: dict[str, dict]) -> str:
    lines = [
    ...
    for export in sorted(exports):
        if export.startswith(HAND_WRITTEN_PREFIXES):
            continue
